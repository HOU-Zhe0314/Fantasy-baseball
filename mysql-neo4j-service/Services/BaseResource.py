...
class ResourceBase():
    ...
    def delete(self, template):
        result = self._data_table.delete(template)
        return result

    def delete_by_key(self, key_values):
        """

        :param key_values: values of primary key. A list.
        """
    ...
    def update(self, key_values, transfer_json, context=None):
        ...
        :param key_values: values of primary key. A list.
        :param transfer_json: A row. The result after updating. A dict.
        """
    ...
    def update_by_template(self, key_values, transfer_json, tup):
        """

        :param key_values: values of primary key. A list.
        :param transfer_json: A row. The result after updating. A dict.
        :param tup: A tuple. Another condition (template) for updating.
        """

        template = dict(zip(self._configInfo.get("key_columns"), key_values))
        template[tup[0]] = tup[1]
